(() => {
	...
	const messages = {
		zh: {
			...
			"home.hero.download": "下载 v0.3.1",
			"home.hero.installOptions": "查看安装方式",
			"home.hero.releaseLabel": "当前版本信息",
			"home.hero.current": "当前版本：v0.3.1",
			"home.hero.manual": "支持手动安装",
			"home.product.alt": "JSON Mate 工作区，左侧是树形视图，右侧是属性面板、快捷工具和显示选项。",
			"home.product.caption": "树形视图、属性面板和快捷工具在同一工作区。",
			"home.install.eyebrow": "安装",
			"home.install.title": "先用发布包安装，商店入口预留中。",
			"home.install.summary": "当前公开版本通过 GitHub 发布包分发。Chrome 和 Edge 可以手动加载解压后的扩展目录；后续商店上架后，这里会切换到对应入口。",
			...
			"privacy.sent.version.description": "例如 0.3.1，用于判断版本分布。",
		...
		en: {
			...
			"home.hero.download": "Download v0.3.1",
			"home.hero.installOptions": "Install options",
			"home.hero.releaseLabel": "Current release details",
			"home.hero.current": "Current: v0.3.1",
			"home.hero.manual": "Manual install available",
			...
			"home.install.title": "Install from releases while store listings are prepared.",
			"home.install.summary": "The public build is distributed through GitHub Releases. Chrome and Edge can load the unpacked extension today; store links will replace these placeholders when they are ready.",
			...
			"privacy.sent.version.description": "For example, 0.3.1, used to understand version distribution.",
