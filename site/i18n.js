(() => {
	...
	const messages = {
		zh: {
			...
			"privacy.sent.version.description": "例如 0.4.0，用于判断版本分布。",
		...
		en: {
			...
			"privacy.sent.version.description": "For example, 0.4.0, used to understand version distribution.",
